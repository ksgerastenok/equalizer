...
begin
  ...
  with (TLabel.Create(Application)) do begin
    ...
    Height := 20;
    ShowHint := True;
    Parent := self.getComponent(TGroupBox, 40) as TWinControl;
  end;
  with (TTrackBar.Create(Application)) do begin
    Font.Size := 8;
    Orientation := trHorizontal;
...
begin
  with (self.getComponent(TTrackBar, 43) as TWinControl) do begin
    Destroy();
  end;
  with (self.getComponent(TLabel, 43) as TWinControl) do begin
    Destroy();
  end;
  with (self.getComponent(TTrackBar, 42) as TWinControl) do begin
    Destroy();
  end;
  with (self.getComponent(TLabel, 42) as TWinControl) do begin
    Destroy();
  end;
  with (self.getComponent(TTrackBar, 41) as TWinControl) do begin
    Destroy();
  end;
  with (self.getComponent(TLabel, 41) as TWinControl) do begin
    Destroy();
  end;
  with (self.getComponent(TGroupBox, 40) as TWinControl) do begin
    Destroy();
  end;
...
begin
  if (Sender is TForm) then begin
    with (Sender as TForm) do begin
      ...
      self.TrackBarLoad(self.getComponent(TTrackBar, 41));
      self.TrackBarLoad(self.getComponent(TTrackBar, 42));
      self.TrackBarLoad(self.getComponent(TTrackBar, 43));
    end;
  end;
end;
...
begin
  if (Sender is TForm) then begin
    with (Sender as TForm) do begin
      ...
      self.TrackBarSave(self.getComponent(TTrackBar, 41));
      self.TrackBarSave(self.getComponent(TTrackBar, 42));
      self.TrackBarSave(self.getComponent(TTrackBar, 43));
    end;
  end;
end;
