...
constructor TWMPDSPBQF.Create(const Filter: TFilter; const Band: TBand; const Gain: TGain);
begin
  inherited Create();
  self.fband := Band;
  self.fgain := Gain;
...
function TWMPDSPBQF.Process(const Input: Double): Double;
begin
  try
    case(self.fgain) of
      gtDb: begin
...
function TWMPDSPBQF.getBand(): TBand;
begin
  Result := self.fband;
end;

function TWMPDSPBQF.getGain(): TGain;
begin
  Result := self.fgain;
end;

function TWMPDSPBQF.getFilter(): TFilter;
begin
  Result := self.ffilter;
end;

function TWMPDSPBQF.getAmp(): Double;
begin
  Result := self.famp;
end;

procedure TWMPDSPBQF.setAmp(const Value: Double);
begin
  self.famp := Value;
end;

function TWMPDSPBQF.getFreq(): Double;
begin
  Result := self.ffreq;
end;

procedure TWMPDSPBQF.setFreq(const Value: Double);
begin
  self.ffreq := Value;
end;

function TWMPDSPBQF.getRate(): Double;
begin
  Result := self.frate;
end;

procedure TWMPDSPBQF.setRate(const Value: Double);
begin
  self.frate := Value;
end;

function TWMPDSPBQF.getWidth(): Double;
begin
  Result := self.fwidth;
end;

procedure TWMPDSPBQF.setWidth(const Value: Double);
begin
  self.fwidth := Value;
end;

function TWMPDSPBQF.getEnabled(): Boolean;
begin
  Result := self.fenabled;
end;

procedure TWMPDSPBQF.setEnabled(const Value: Boolean);
begin
  self.fenabled := Value;
end;
