...
function Init(const Module: PModule): Integer; cdecl;
var
  f: file;
  i: LongWord;
begin
...
procedure Quit(const Module: PModule); cdecl;
var
  f: file;
  i: LongWord;
begin
...
function Modify(const Module: PModule; const Data: Pointer; const Samples: Integer; const Bits: Integer; const Channels: Integer; const Rates: Integer): Integer; cdecl;
begin
...
procedure Config(const Module: PModule); cdecl;
begin
  TWMPDSPFRM.Instance().Show();
end;

function Module(const Which: Integer): PModule; cdecl;
begin
  Result := nil;
  case (Which) of
    0: begin
