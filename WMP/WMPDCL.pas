...
type
  ...
  TPlugin = record
    ...
    var Modify: function(const Module: PPlugin; const Buffer: Pointer; const Samples: LongWord; const Bits: LongWord; const Channels: LongWord; const Rates: LongWord): Integer; cdecl;
