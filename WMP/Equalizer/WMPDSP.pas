...
function TWMPDSP.getData(const Channel: LongWord; const Sample: LongWord): Double;
begin
...
procedure TWMPDSP.setData(const Channel: LongWord; const Sample: LongWord; const Value: Double);
begin
  case (self.fdata.Bits) of
    8: begin
