...
class function TWMPDSP.getSamples(const Data: PData; const Sample: Integer; const Channel: Integer): Double;
var
  x: Double;
  p: Pointer;
begin
...
class procedure TWMPDSP.setSamples(const Data: PData; const Sample: Integer; const Channel: Integer; const Value: Double);
var
  x: Double;
  p: Pointer;
begin
