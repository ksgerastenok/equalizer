...
begin
  TWMPEQZ.fequ.Init();
  TWMPEQZ.ffrm.Init(TWMPEQZ.fequ.Info);
  Result := 0;
end;
...
begin
  TWMPEQZ.fequ.Data.Data := Data;
  TWMPEQZ.fequ.Data.Bits := Bits;
  TWMPEQZ.fequ.Data.Rates := Rates;
  TWMPEQZ.fequ.Data.Samples := Samples;
  TWMPEQZ.fequ.Data.Channels := Channels;
  TWMPEQZ.fequ.Process();
  Result := Samples;
end;
