...
begin
  ...
  if (self.fenabled) then begin
    for k := 0 to self.fdsp.Data.Channels - 1 do begin
      ...
      for x := 0 to self.fdsp.Data.Samples - 1 do begin
        if (b <= a) then begin
          y := b * (x * (a - b * (1.0 + 0.01)) + 0.01 * a * 0.3 * self.fdsp.Data.Rates) / (x * (a - b * (1.0 + 0.01)) + 0.01 * b * 0.3 * self.fdsp.Data.Rates);
        end         else begin
          y := b * (x * (a - b * (1.0 - 0.01)) - 0.01 * a * 9.0 * self.fdsp.Data.Rates) / (x * (a - b * (1.0 - 0.01)) - 0.01 * b * 9.0 * self.fdsp.Data.Rates);
        end;
