...
constructor TQMPDSPPLG.Create();
begin
  inherited Create();
  self.fdata := New(PWriteData);
end;

destructor TQMPDSPPLG.Destroy();
begin
  Dispose(self.fdata);
  inherited Destroy();
end;

function TQMPDSPPLG.getData(): PWriteData;
begin
  Result := self.fdata;
end;

function TQMPDSPPLG.getSamples(const Sample: LongWord; const Channel: LongWord): Double;
var
  x: Double;
  p: Pointer;
begin
...
procedure TQMPDSPPLG.setSamples(const Sample: LongWord; const Channel: LongWord; const Value: Double);
var
  x: Double;
  p: Pointer;
begin
