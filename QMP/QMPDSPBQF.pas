...
constructor TQMPDSPBQF.Create(const Filter: TFilter; const Band: TBand; const Gain: TGain);
begin
  inherited Create();
  self.fband := Band;
  self.fgain := Gain;
...
function TQMPDSPBQF.Process(const Input: Double): Double;
begin
  try
    case(self.fgain) of
      gtDb: begin
...
function TQMPDSPBQF.getBand(): TBand;
begin
  Result := self.fband;
end;

function TQMPDSPBQF.getGain(): TGain;
begin
  Result := self.fgain;
end;

function TQMPDSPBQF.getFilter(): TFilter;
begin
  Result := self.ffilter;
end;

function TQMPDSPBQF.getAmp(): Double;
begin
  Result := self.famp;
end;

procedure TQMPDSPBQF.setAmp(const Value: Double);
begin
  self.famp := Value;
end;

function TQMPDSPBQF.getFreq(): Double;
begin
  Result := self.ffreq;
end;

procedure TQMPDSPBQF.setFreq(const Value: Double);
begin
  self.ffreq := Value;
end;

function TQMPDSPBQF.getRate(): Double;
begin
  Result := self.frate;
end;

procedure TQMPDSPBQF.setRate(const Value: Double);
begin
  self.frate := Value;
end;

function TQMPDSPBQF.getWidth(): Double;
begin
  Result := self.fwidth;
end;

procedure TQMPDSPBQF.setWidth(const Value: Double);
begin
  self.fwidth := Value;
end;

function TQMPDSPBQF.getEnabled(): Boolean;
begin
  Result := self.fenabled;
end;

procedure TQMPDSPBQF.setEnabled(const Value: Boolean);
begin
  self.fenabled := Value;
end;
