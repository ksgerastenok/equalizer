...
function TQMPBQF.getValue(): Double;
begin
  case (self.fgain) of
    gtDb: begin
...
function TQMPBQF.Process(const Data: Double): Double;
begin
  case (self.ftransform) of
    ptLAT: begin
...
procedure TQMPBQF.setAmp(const Data: Double);
begin
...
procedure TQMPBQF.setFreq(const Data: Double);
begin
...
procedure TQMPBQF.setRate(const Data: Double);
begin
...
procedure TQMPBQF.setWidth(const Data: Double);
begin
