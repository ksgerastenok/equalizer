...
procedure TQMPNRM.Init(const Transform: TTransform; const Filter: TFilter; const Band: TBand; const Gain: TGain);
begin
...
function TQMPNRM.getBand(): TBand;
begin
...
function TQMPNRM.getFilter(): TFilter;
begin
...
function TQMPNRM.getFreq(): Double;
begin
  Result := self.fbqf.Freq;
end;

procedure TQMPNRM.setFreq(const Value: Double);
begin
...
function TQMPNRM.getWidth(): Double;
begin
  Result := self.fbqf.Width;
end;

procedure TQMPNRM.setWidth(const Value: Double);
begin
  self.fbqf.Width := Value;
end;

procedure TQMPNRM.addSample(const Value: Double);
begin
