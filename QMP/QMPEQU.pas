...
begin
  for var k := 0 to Length(TQMPEQU.feqz) - 1 do begin
    for var i := 0 to Length(TQMPEQU.feqz[k]) - 1 do begin
...
begin
  if((TQMPEQU.fdsp.Info.Enabled)) then begin
    ...
    for var k := 0 to TQMPEQU.fdsp.Data.Channels - 1 do begin
      for var i := 0 to Length(TQMPEQU.fdsp.Info.Bands) - 1 do begin
        ...
        for var x := 0 to TQMPEQU.fdsp.Data.Samples - 1 do begin
