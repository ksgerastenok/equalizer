...
type
  ...
  private
    ...
    class function getDSP(): TQMPDSP; cdecl; static;
  ...
  public
    ...
    class property DSP: TQMPDSP read getDSP;
  end;
...
class function TQMPEQU.getDSP(): TQMPDSP; cdecl;
begin
  Result := TQMPEQU.fdsp;
end;

class procedure TQMPEQU.Initialize(); cdecl;
var
  k: Integer;
  i: Integer;
begin
  TQMPEQU.fdsp := TQMPDSP.Create();
...
class procedure TQMPEQU.Finalize(); cdecl;
var
  k: Integer;
  i: Integer;
begin
