...
begin
  if((TQMPEQU.DSP.Info.Enabled)) then begin
    ...
    for var k := 0 to TQMPEQU.DSP.Data.Channels - 1 do begin
      for var i := 0 to Length(TQMPEQU.DSP.Info.Bands) - 1 do begin
        ...
        for var x := 0 to TQMPEQU.DSP.Data.Samples - 1 do begin
