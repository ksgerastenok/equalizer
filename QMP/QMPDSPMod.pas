...
function TQMPDSPMod.getData(): PWriteData;
begin
  Result := self.fdata;
end;

function TQMPDSPMod.getSamples(const Sample: LongWord; const Channel: LongWord): Double;
var
  x: Double;
  p: Pointer;
begin
...
procedure TQMPDSPMod.setSamples(const Sample: LongWord; const Channel: LongWord; const Value: Double);
var
  x: Double;
  p: Pointer;
begin
