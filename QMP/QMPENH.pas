...
begin
  ...
  Result.Open := TQMPENH.Open;
  Result.Stop := TQMPENH.Stop;
...
class function TQMPENH.Open(const Media: PChar; const Format: Pointer; const Flags: Integer): Integer; cdecl;
begin
  TQMPENH.fwidth := Power(10, 5.0 / 20);
  Result := 1;
end;

class procedure TQMPENH.Stop(const Flags: Integer); cdecl;
begin
  TQMPENH.fwidth := Power(10, 0.0 / 20);
end;
