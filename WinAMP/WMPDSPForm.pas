...
type
  ...
  public
    procedure Process(const Data: Pointer; const Samples: Integer; const Bits: Integer; const Channels: Integer; const Rates: Integer);
  end;
...
procedure TWMPDSPForm.Process(const Data: Pointer; const Samples: Integer; const Bits: Integer; const Channels: Integer; const Rates: Integer);
begin
