...
function TWMPDSPPlug.getInfo(): PEQInfo;
begin
  Result := self.finfo;
end;
...
function TWMPDSPPlug.getSamples(const Channel: LongWord; const Sample: LongWord): Double;
var
  x: Double;
  p: Pointer;
begin
...
procedure TWMPDSPPlug.setSamples(const Channel: LongWord; const Sample: LongWord; const Value: Double);
var
  x: Double;
  p: Pointer;
begin
