...
- Enhancer (aka Bass/Treble Enhancer + Dynamic Volume Normalizer) WinAmp plugin written in Free Pascal (Delphi dialect)
- Enhancer (aka Bass/Treble Enhancer + Dynamic Volume Normalizer) QMP plugin written in Free Pascal (Delphi dialect)
- Dynamic Volume Normalizer WinAmp plugin written in Free Pascal (Delphi dialect)
- Dynamic Volume Normalizer QMP plugin written in Free Pascal (Delphi dialect)
